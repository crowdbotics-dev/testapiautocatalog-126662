...
## Project Structure
    ...
    ├── testapiautocatalog_126662  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_126662`
...
2. Clone this repo and `cd testapiautocatalog_126662`
